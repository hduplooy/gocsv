// This is an extension of the standard go csv reader
...
//
// The header line can be skipped by setting SkipHeader to true.
//
// Fields which start and stop with the quote character (default ") are called
// quoted-fields. The beginning and ending quote are not part of the
// field. The qoute character can be changed as needed.
//
// The source:
//
...
type Reader struct {
	...
	fieldIndexes []int
	// Quote is the quote character used
	// it defaults to "
